...
extern const unsigned short tilemap_ground_v1Tiles[320];
...
extern const unsigned short tilemap_mountainsv1Tiles[45664];
...
enum { PLAYERIDLE, PLAYERRUN = 2, PLAYERJUMP = 4, PLAYERATTACK = 6 };
